package com.example.loginidris;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backIntent = new Intent(DaftarActivity.this, MainActivity.class);
            ...
            public void onClick(View v) {
                ...
                if (strPassword.equals(strPasswordconf)){
                    ...
                    if (daftarakun == true){
                        ...
                        Intent daftarakunIntent = new Intent(DaftarActivity.this, MainActivity.class);
